...
class GroupFeatures(models.Model):
    ...
    about_page              = models.CharField(max_length=64, accepted_empty_values=[[], {}], blank=False, default="ietf.group.views.group_about" )
    default_tab             = models.CharField(max_length=64, accepted_empty_values=[[], {}], blank=False, default="ietf.group.views.group_about" )
